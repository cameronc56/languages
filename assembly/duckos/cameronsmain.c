...
//void outb(unsigned short port, unsigned char value) {
	//when outb is declared, EBP points to top of stack along with esp
	//value is pushed to stack. ESP increments by 4, EBP stays the same
	//port is pushed to stack. ESP increments by 8, EBP stays the same
	//ebp+12 means 12 bytes up the stack... which is where value starts
	//ebp+8 grabs the port, which starts 8 bytes up the stack
//	__asm__(
//		"mov AL, [ebp+12]\n"
//		"mov DX, [ebp+8]\n"
//		"outb DX, AL\n"
//	);
//}	//function ends, everything is popped of the stack up to EBP, ESP = EBP
